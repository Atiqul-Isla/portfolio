...
const Examples = () => {
  ...
  return (
    ...
    <div id='projects' className='mt-[70vh] 2xl:mt-[20vh] w-full'>
        <div className='container mx-auto  p-12 rounded-2xl'>
            ...
            <div className='grid  xs:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-6 gap-y-6 grid-flow-row-dense h-[350vh] lg:h-[350vh] xl:h-[150vh] max-h-[350vh] max-lg:h-[350vh] max-xl:h-[150vh]'>
